...
class WritePaper(Tool):
    ...
    async def execute(
        ...
        **kwargs,
        ...
        experiments = self.agent.data.get("experiments", {})
        ...
        if not idea:
            ideas = self.agent.data.get("research_ideas", {})
        ...
        if "papers" not in self.agent.data:
            self.agent.data["papers"] = {}

        self.agent.data["papers"][idea_name] = {
            "idea_name": idea_name,
            "format": format,
