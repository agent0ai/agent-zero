...
This repo is a fork of [agent0ai/agent-zero](https://github.com/agent0ai/agent-zero). The upstream project still uses a plain `requirements.txt`. When merging upstream changes:
