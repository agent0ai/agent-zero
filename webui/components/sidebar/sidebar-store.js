...
const model = {
  ...
  // Called by Alpine x-on:shown.bs.collapse event
  onSectionShown(name) {
    this.sectionStates[name] = true;
    this.persistSectionStates();
  },

  // Called by Alpine x-on:hidden.bs.collapse event
  onSectionHidden(name) {
    this.sectionStates[name] = false;
    this.persistSectionStates();
  },
