...
- [ ] Ran `ruff check .` and fixed all issues
- [ ] Ran `ruff format .` to format code
- [ ] Ran `pytest tests/` and all tests pass
- [ ] Ran `mypy .` for type checking (if applicable)
- [ ] Ran `pre-commit run --all-files` and resolved all issues
