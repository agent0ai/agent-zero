...
- `requirements.txt` — 53 Python dependencies
- `requirements.dev.txt` — pytest, pytest-asyncio, pytest-mock
- `requirements2.txt` — Additional requirements
...
2. `python run_ui.py` (starts on http://localhost:0)
3. Configure API keys in UI settings
