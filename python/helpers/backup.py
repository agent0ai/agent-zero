...
class BackupService:
    ...
    def __init__(self):
        ...
        self.base_paths = {
            self.magui_root: self.magui_root,
        }
    ...
    def get_default_backup_metadata(self) -> Dict[str, Any]:
        ...
        return {
            "backup_name": f"magui-backup-{timestamp[:10]}",
    ...
    def _get_default_patterns(self) -> str:
        ...
        Only includes Magui project directory patterns.
        """
...
"""
    ...
    def _translate_patterns(self, patterns: List[str], backup_metadata: Dict[str, Any]) -> List[str]:
        ...
        Replaces the backed up Magui root path with the current Magui root path
        ...
        Args:
            ...
            backup_metadata: Backup metadata containing the original magui_root
        ...
        current_agent_root = self.magui_root
