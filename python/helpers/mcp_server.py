...
class DynamicMcpProxy:
    ...
    def reconfigure(self, token: str):
        ...
        # Update settings using the global fastmcp.settings
        fastmcp_settings.set_setting("message_path", message_path)
        fastmcp_settings.set_setting("sse_path", sse_path)
        ...
        with self._lock:
            ...
            # For HTTP, try using the built-in create_streamable_http_app
            # If lifespan issues occur in Flask/Werkzeug, we may need to revert to custom implementation
