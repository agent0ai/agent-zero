...
def deserialize_task(task_data: Dict[str, Any], task_class: Optional[Type[T]] = None) -> T:
    ...
    common_args = {
        ...
        # Support older tasks with project_* fields
        "project_name": task_data.get("project", {}).get("name", task_data.get("project_name")),
        "project_color": task_data.get("project", {}).get("color", task_data.get("project_color")),
