...
Converted from Mahoosuc OS /security:audit command to native Agent Zero tool.
...
class SecurityAudit(Tool):
    ...
    def _generate_audit_report(self, scope: str, severity: str) -> str:
        ...
        lines.append(
            "*For production use, integrate with security scanners (Snyk, SonarQube, OWASP ZAP, Bandit)*"
        )
