...
- [`_bundled_skills/skills/a0-create-plugin/SKILL.md`](_bundled_skills/skills/a0-create-plugin/SKILL.md): Agent-facing authoring entrypoint with implementation, review, and contribution references.
- [`_bundled_skills/skills/a0-manage-plugin/SKILL.md`](_bundled_skills/skills/a0-manage-plugin/SKILL.md): Find useful Index plugins and manage installation, configuration, and lifecycle.
