### a2a_chat:
This tool lets {{brand_name}} chat with any other FastA2A-compatible agent.
...
#### Arguments
- `agent_url` (string, required) – Base URL of the _remote_ agent.
...
#### Notes
1. **New conversation** – omit previous `agent_url` or use a _different_ URL.
