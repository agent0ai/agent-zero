#!/bin/bash
# Configure Agent Zero to use Ollama with Qwen model

echo "Configuring Agent Zero to use Ollama with Qwen2.5-Coder..."

# Update the .env file to add Ollama configuration
cat >> /home/webemo-aaron/projects/agent-zero/.env << 'EOF'
...
echo ""
echo "Now you need to configure the chat model in the Agent Zero web UI:"
