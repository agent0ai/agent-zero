...
- **Reusable skill:** contribute it to Agent Zero's bundled skills collection under `plugins/_skills/skills/` or publish it in a dedicated public repository/collection.
