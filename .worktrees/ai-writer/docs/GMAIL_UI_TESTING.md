...
2. Create new project: `agent-zero-gmail`
3. Enable Gmail API:
...
4. Create OAuth2 Credentials:
   ...
   - Name: `Agent Zero Gmail Integration`
...
**Steps:**
1. Open Agent Zero UI (http://localhost:5000)
...
**Steps:**
1. Add Gmail account
2. Restart Agent Zero (`Ctrl+C`, then `python run_ui.py`)
3. Check account list
...
### Environment
- Agent Zero version: [git commit hash]
