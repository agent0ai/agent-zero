...
Agent Zero now supports **Hardware-Bound Authentication** using Passkeys. This allows you to centralize all authorization via your phone or hardware security key (like YubiKey), providing a seamless "Power User" experience.
...
1. **Prerequisites**:
   - Ensure you are accessing Agent Zero over **HTTPS** (or `localhost` for local development). Passkeys require a "Secure Context".
...
3. **Verification**:
   - Once registered, your phone is bound to your Agent Zero instance.
